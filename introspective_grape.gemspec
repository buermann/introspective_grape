...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency "rails", '5.2.6' #, '< 6'
  s.add_runtime_dependency "schema_validations"
  s.add_runtime_dependency "rack"   # grape < 1.3.0 is incompatible with rack 2.1.0
  s.add_runtime_dependency 'grape'  #, '1.3.2'
  s.add_runtime_dependency 'dry-types'  #, '1.3.2'
  s.add_runtime_dependency 'grape-entity'
  s.add_runtime_dependency 'grape-swagger'
  s.add_runtime_dependency 'kaminari' #, '< 1.0' # version 1.0.0 breaks
  s.add_runtime_dependency 'grape-kaminari' #, '< 1.0' # version 1.0.0 breaks
